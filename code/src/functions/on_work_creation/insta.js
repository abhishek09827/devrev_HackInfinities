        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, response.data]; // SReturn only the data part of the response
                case 2:
                    error_1 = _a.sent();
                    console.error('Error fetching data:', error_1); // Log the error response data if available
